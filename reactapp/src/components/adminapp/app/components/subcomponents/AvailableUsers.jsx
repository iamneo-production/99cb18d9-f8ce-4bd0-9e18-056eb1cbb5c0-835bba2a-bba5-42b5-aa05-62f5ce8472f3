  ...
  return (
    <>
      <tr className="a-user-table-row">
        ...
        <td>{count}</td>
        <td>{location}</td>
        <td className="a-users-t-h-cen">{<SellerConButtons />}</td>
      </tr>
    </>
  );
}
function SellerConButtons() {
  return (
    <>
      <div className="a-user-scb">
        <button className="a-user-cb-btn">
          <span
